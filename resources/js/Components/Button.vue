...
const props = defineProps({
    variant: {
        ...
        default: 'primary',
        validator(value) {
            return ['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'black', 'transparent'].includes(value)
        },
    },
    type: {
        type: String,
...
const variantClasses = (variant) => ({
    'bg-bilbao-800 text-white hover:bg-bilbao-700 focus:ring-bilbao-800': variant === 'primary',
    'bg-bilbao-100 text-bilbao-800 hover:bg-bilbao-200 focus:ring-bilbao-100':
        variant === 'secondary',
